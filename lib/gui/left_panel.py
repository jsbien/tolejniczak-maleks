...
class MainIndicesPanel(IndexPanel):
	...
	def _buildFicheIndexGUI(self):
		...
		self._sizer.Add(wx.StaticText(self, label=_("Comment") + ":"))
		self._sizer.Add(self.__comment, 1, wx.EXPAND)
