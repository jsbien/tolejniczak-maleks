...
manpages = set()
data_files = [('share/man/man1', manpages), ('share/maleks/res', ['res/binary.png', 'res/chreg.png', 'res/edins.png', 'res/edpre.png', 'res/hins.png', 'res/next.png', 'res/prev.png', 'res/up.png', 'res/back.png'])]
